...
from msedge.selenium_tools import EdgeOptions, Edge  # 导入Edge选项
...
def auto_login(area, keyword, url):
    ...
    page = area['page']
    edge_options = EdgeOptions()  # option = ChromeOptions()
    edge_options.use_chromium = True
    # edge_options.add_argument('--headless')  # 创建chrome浏览器驱动，无头模式（超爽）
    # edge_options.add_argument(
        # "--user-data-dir="+r"C:/Users/灰木炭/AppData/Local/Microsoft/Edge/User Data/")  # 带插件的浏览器
    # driver = webdriver.Chrome(chrome_options=chrome_options)
    driver = Edge(
        executable_path=r'D:\02Run\edgedriver_win64\msedgedriver.exe', options=edge_options)
    ...
    # 选择搜索关键词
    driver.find_element_by_xpath(
        '//*[@id="home-header-searchbox"]').send_keys(keyword)
    driver.find_element_by_xpath(
    ...
    area = driver.find_element_by_xpath(
        '//*[@id="render-engine-page-container"]/div/div[6]/div[2]/div[1]')
    ...
    # 阿里巴巴前端更新 这个是城市选择湖北
    driver.find_element_by_xpath(
        '//*[@id="render-engine-page-container"]/div/div[6]/div[2]/div[2]/ul[2]/li[16]').click()
    driver.implicitly_wait(10)
    sleep(1)
    count = 1
